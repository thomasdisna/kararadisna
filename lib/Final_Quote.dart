...
class FinalQuote extends StatefulWidget {
  @override
  _FinalQuoteState createState() => _FinalQuoteState();
}

class _FinalQuoteState extends State<FinalQuote> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8,),
              Container(height: 57,width: w/2+20,decoration: BoxDecoration(color:orgC, borderRadius:BorderRadius.only(topLeft:Radius.circular(10),topRight:Radius.circular(10)),),),
              Container(width: w,
