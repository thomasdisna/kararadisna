...
class RFQIntitatepopup extends StatefulWidget {
  @override
  _RFQIntitatepopupState createState() => _RFQIntitatepopupState();
}

class _RFQIntitatepopupState extends State<RFQIntitatepopup> {
  @override
                  ...
                  return Dialog(
                    child: Container(height:200,width: w/1.4, decoration: BoxDecoration(color:Colors.white,borderRadius:BorderRadius.circular(50),
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          SizedBox(height:20,),
                          Text("Initiate RFQ",style: f16w900butC,),
                          SizedBox(height: 20,),
                          Text("Do you want to initiate",style: f10lgtC,),
                          SizedBox(height: 10,),
                          Text("RFQ for this requirement",style: f10lgtC,),
                          SizedBox(height: 10,),
