...
class SubmitPop extends StatefulWidget {
  @override
  _SubmitPopState createState() => _SubmitPopState();
}

class _SubmitPopState extends State<SubmitPop> {
  @override
          ...
          onPressed: (){
            showDialog(
                ...
                builder: (BuildContext context) {
                  return Dialog(
                    child: Container(height:300,width: w/1.4, decoration: BoxDecoration(color:Colors.white,borderRadius:BorderRadius.circular(50),
                      ...
                      Column(
                        children: [
                          SizedBox(height:60,),
                          Text("Credit will be Deducted",style: f16w900butC,),
                          SizedBox(height: 10,),
                          Text("1.will be deducted from your account",style: f10lgtC,),
                          SizedBox(height: 10,),
                          ...
                          MaterialButton(shape: RoundedRectangleBorder(
                            ...
                            onPressed: (){},child: Text("Yes,Deduct and Continue",
                              style: TextStyle(color: Colors.white,fontFamily: font1,
