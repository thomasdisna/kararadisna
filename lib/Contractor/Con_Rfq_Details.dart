...
class Con_Rfq_Details extends StatefulWidget {
  @override
  _Con_Rfq_DetailsState createState() => _Con_Rfq_DetailsState();
}

class _Con_Rfq_DetailsState extends State<Con_Rfq_Details> {
  @override
                        ...
                        children: [
                          InkWell(
                            ...
                            child: MaterialButton(shape: RoundedRectangleBorder(
                              ...
                              onPressed: (){},child: Text("View Quote",
                                style: TextStyle(color: Colors.white,fontFamily: font1,
                                    fontWeight: FontWeight.w600,fontSize: 12),),color: butC,),
                          ),
                    ...
                    children: [
                      ...
                      Container(width: w, decoration: BoxDecoration(color:Colors.white,borderRadius:BorderRadius.circular(10),
                        ...
                        child: Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Reviews",style: f13grnCw600,),
                              Padding(
                                padding: const EdgeInsets.all(5.0),
